...
class FirClassSubstitutionScope(
    session: FirSession,
    val unsubsituted: FirScope,
    val substitution: Map<ConeTypeParameterSymbol, ConeKotlinType>,
    lookupInFir: Boolean
    ...
    fun wrapProjection(old: ConeKotlinTypeProjection, newType: ConeKotlinType): ConeKotlinTypeProjection {
        return when (old) {
    ...
    fun ConeKotlinType.substitute(): ConeKotlinType? {
    ...
    override fun processFunctionsByName(name: Name, processor: (ConeFunctionSymbol) -> ProcessorAction): ProcessorAction {
        unsubsituted.processFunctionsByName(name) process@{ original ->
    ...
    override fun processPropertiesByName(name: Name, processor: (ConePropertySymbol) -> ProcessorAction): ProcessorAction {
        return unsubsituted.processPropertiesByName(name, processor)
    }
    ...
    private fun createFakeOverride(
        ...
        val member = (original as FirBasedSymbol<FirCallableMember>).fir as? FirNamedFunction ?: error("Can't fake override for $original")
