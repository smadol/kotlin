        ...
        for (file in root.walkTopDown()) {
            ...
            psiSetDirect.removeIf {
                it is KtPackageDirective || it is KtImportList || it is KtClassBody ||
                        ...
                        // TODO: looks at annotations / annotationEntries
                        it is KtFileAnnotationList || it is KtAnnotationUseSiteTarget ||
                        ...
                        (it.parent is KtUserType || it.parent is KtInstanceExpressionWithLabel || it.parent is KtValueArgumentName) ||
