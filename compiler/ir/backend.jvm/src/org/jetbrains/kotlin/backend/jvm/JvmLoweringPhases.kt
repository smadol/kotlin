...
private val JvmTypeOperatorLoweringPhase = makeJvmPhase(
...
private val JvmBuiltinOptimizationLoweringPhase = makeJvmPhase(
...
val jvmPhases: List<CompilerPhase<JvmBackendContext, IrFile>> = listOf(
    ...
    TailrecPhase,
    ToArrayPhase,
    JvmTypeOperatorLoweringPhase,
    JvmBuiltinOptimizationLoweringPhase,
