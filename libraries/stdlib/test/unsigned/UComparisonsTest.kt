...
class UComparisonsTest {
    ...
    fun minOf_2() {
        ...
        expect(UInt.MIN_VALUE) { min(UInt.MIN_VALUE, UInt.MAX_VALUE) }
        expect(42312uL) { min(42312uL, 42312uL) }
    }
    ...
    @Test
    fun maxOf_2() {
        expect(2.toUByte()) { max(2.toUByte(), 1.toUByte()) }
        expect(32768.toUShort()) { max(58.toUShort(), 32768.toUShort()) }
