...
class UnsignedArraysTest {
    ...
    fun minBy() {
        ...
        expect(2uL) { arrayOf<ULong>(3, 2).minBy { it * it } }
    }
    ...
    fun minByInUnsignedArrays() {
        ...
        expect(2uL) { ulongArrayOf(3, 2).minBy { it * it } }
    }
    ...
    fun maxBy() {
        ...
        expect(3u) { arrayOf<UInt>(2, 3).maxBy { it + 1 } }
    ...
    fun maxByInUnsignedArrays() {
        ...
        expect(3u) { uintArrayOf(2, 3).maxBy { it + 1 } }
    ...
    fun reduceIndexed() {
        ...
        expect(UInt.MAX_VALUE) { uintArrayOf(1, 2, 3).reduceIndexed { index, acc, e -> index.toUInt() + e - acc } }
        expect(ULong.MAX_VALUE) { ulongArrayOf(1, 2, 3).reduceIndexed { index, acc, e -> index.toULong() + e - acc } }
